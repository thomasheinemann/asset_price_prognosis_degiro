...
class DeGiro:
    ...
    __LOGIN_URL_TOTP = 'https://trader.degiro.nl/login/secure/login/totp'   # https://gist.github.com/rkulow/5917485a0a657b31a2b74dd06b15490b
    ...
    def login(self, username, password, totp):
        ...
        login_response = self.__request(DeGiro.__LOGIN_URL_TOTP, None, login_payload, request_type=DeGiro.__POST_REQUEST,
    ...
    def buyorder(self, orderType, productId, timeType, size, limit=None, stop_loss=None):
        place_buy_order_params = {
            'intAccount': "31120518", #self.client_info.account_id,
            'sessionId': self.session_id,
        }
